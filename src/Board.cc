...
//        Unit &target = *nonActivePlayer->getField(); // not sure if i can pass a card reference here
//        activePlayer->attack(m1, target);
//    } else { // attack the enemy face
//    activePlayer->attack(m1, nonActivePlayer->mgetFace);
//    }
//}
...
//void Board::checkTrigger(int trigger) { TODO
    // 1 = beginning of turn
    // 2 = end of turn
    // 3 = minion is played
    // 4 = minion dies
